      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Have questions about concerts, tickets, or venues? 
          ...
          <div className="space-y-8">
            <div className="glass-effect rounded-lg p-6 md:p-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="bg-concert-purple p-3 rounded-full mr-4">
                    <Mail className="h-6 w-6 text-white" />
                  </div>
                  <div>
                    <h3 className="font-semibold text-lg">Email</h3>
                    <p className="text-gray-300">info@melodytix.com</p>
                    <p className="text-gray-300">support@melodytix.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">Melody City, MC 12345</p>
            ...
            <div className="glass-effect rounded-lg p-6 md:p-8">
              ...
              <div className="flex space-x-4">
                <a href="#" className="bg-concert-purple hover:bg-opacity-80 p-3 rounded-full">
        ...
        <div className="mt-16 rounded-lg overflow-hidden">
          <div className="aspect-[16/7] bg-gray-800 flex items-center justify-center">
            <div className="text-center">
              <MapPin className="h-12 w-12 text-concert-purple mx-auto mb-4" />
              <p className="text-xl font-bold">Map placeholder</p>
              <p className="text-gray-400">In a real application, an interactive map would be displayed here</p>
            </div>
          </div>
        </div>
      </div>
